...
<div class="wrapper-content">
	<div class="ibox">
		<div class="ibox-title">
			<h5>字典${not empty dict.id?'修改':'添加'}</h5>
		</div>
		<div class="ibox-content">
			...
			<form:form id="inputForm" modelAttribute="dict" action="${ctx}/sys/dict/save" method="post" class="form-horizontal">
				...
				<div class="row">
					<div class="col-sm-6">
						<div class="form-group">
			            	<label class="col-sm-4 control-label"><font color="red">*</font>键值</label>
			            	 <div class="col-sm-8">
		            ...
		            <div class="col-sm-6">
						<div class="form-group">
			            	<label class="col-sm-4 control-label"><font color="red">*</font>标签</label>
			            	 <div class="col-sm-8">
		        ...
		        <div class="row">
		            ...
		            <div class="col-sm-6">
						<div class="form-group">
			            	<label class="col-sm-4 control-label"><font color="red">*</font>描述</label>
			            	 <div class="col-sm-8">
		        ...
		        <div class="row">
					<div class="col-sm-6">
						<div class="form-group">
			            	<label class="col-sm-4 control-label"><font color="red">*</font>排序</label>
			            	 <div class="col-sm-8">
