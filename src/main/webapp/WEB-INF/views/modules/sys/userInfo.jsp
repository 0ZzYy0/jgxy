						...
						<div class="ibox-content">
							...
							<div class="row">
								<div class="col-sm-2 text-center">
									<img alt="image" class="img-circle text-center" src="${user.photo }" width="300px" height="300px"/>
									<br><br>
									<a href="${ctx}/sys/user/imageEdit" class="btn btn-white"><i class="ace-icon fa fa-image"></i> 更换头像</a>
									<a href="#" onclick="openDialog('编辑资料', '${ctx}/sys/user/infoEdit','800px', '500px')" class="btn btn-white"><i class="ace-icon fa fa-pencil"></i> 编辑资料</a>
								</div>
								<div class="col-sm-1">
