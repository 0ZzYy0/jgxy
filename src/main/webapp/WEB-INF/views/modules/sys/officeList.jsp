		...
		<div class="ibox-content">
			...
			<td>
				...
				<shiro:hasPermission name="sys:office:edit">
					<a href="${ctx}/sys/office/form?id={{row.id}}" class="btn btn-success btn-xs" title="修改"><i class="fa fa-edit"></i> 修改</a>
				</shiro:hasPermission>
				<shiro:hasPermission name="sys:office:del">
					<a href="${ctx}/sys/office/delete?id={{row.id}}" onclick="return confirmx('要删除该机构及所有子机构项吗？', this.href)" class="btn btn-danger btn-xs" title="删除"><i class="fa fa-trash"></i> 删除</a>
				</shiro:hasPermission>
				<shiro:hasPermission name="sys:office:add">
					<a href="${ctx}/sys/office/form?parent.id={{row.id}}" class="btn btn-success btn-xs" title="添加下级机构"><i class="fa fa-plus"></i> 添加下级</a>
				</shiro:hasPermission>
			</td>
			</tr>
			</script>
