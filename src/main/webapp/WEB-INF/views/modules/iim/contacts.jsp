                        ...
                        <p>
                        	...
                        	<form:form id="searchForm" modelAttribute="user" action="${ctx}/iim/contact/index" method="post" class="input-group">
                                ...
                                <span class="input-group-btn">
                                        <button type="button" class="btn btn-white btn-sm" onclick="return search();"><i class="fa fa-search"></i> 搜索</button>
                                </span>
							</form:form>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-hover">
                                               ...
                                               <c:forEach items="${list}" var="user">
													<tr>
														<td class="client-avatar"><img alt="image" src="${user.photo}" onerror="this.src='http://www.yee800.com/user.png'"> </td>
                                                        ...
                                                        <td class="client-status">
                                                         <c:if test="${user.bindWx == '1'}">
                                                         	<span class="label label-info" title="已经加入企业微信">企业微信</span>
                                                         </c:if>
                                                        </td>
