                ...
                <div class="mail-box">
					...
					<form:form id="inputForm" modelAttribute="mailBox" action="${ctx}/tools/sms/send" method="post" class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                  	  <input type="text" placeholder="输入多个手机号码请用英文符号,隔开" id="tels" name="tels"  class="form-control width100" value="">
                                </div>
                            </div>
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                  	   <textarea id="content" name="content"  class="form-control width100" required="" aria-required="true"></textarea>
                                </div>
                            </div>
