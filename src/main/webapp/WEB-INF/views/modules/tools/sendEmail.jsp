                ...
                <div class="mail-box">
					...
					<form:form id="inputForm" modelAttribute="mailBox" action="${ctx}/tools/email/send" method="post" class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                  	  <input type="text" placeholder="输入多个邮件地址请用英文符号;隔开" id="emailAddress" name="emailAddress"  class="form-control width100" value="">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" id="title" name="title"  class="form-control width100" value="">
                                </div>
                            </div>
