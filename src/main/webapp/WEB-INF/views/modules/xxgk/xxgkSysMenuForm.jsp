...
<div class="ibox">
	<div class="ibox-title">
		<h5>菜单(树结构)${not empty xxgkSysMenu.id?'修改':'添加'}</h5>
	</div>
	<div class="ibox-content">
		<sys:message content="${message}"/>

		<form:form id="inputForm" modelAttribute="xxgkSysMenu" action="${ctx}/xxgk/xxgkSysMenu/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
			...
			<div class="row">
				<div class="col-sm-6">
					<div class="form-group">
						...
						<div class="col-sm-8">
							<sys:treeselect id="parent" name="parent.id" value="${xxgkSysMenu.parent.id}" labelName="parent.name" labelValue="${xxgkSysMenu.parent.name}"
								title="上级分类" url="/xxgk/xxgkSysMenu/treeData" extId="${xxgkSysMenu.id}" cssClass="form-control" allowClear="true"/>
						</div>
					</div>
				</div>
			</div>
