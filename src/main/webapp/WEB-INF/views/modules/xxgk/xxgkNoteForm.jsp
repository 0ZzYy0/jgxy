...
<div class="ibox">
	<div class="ibox-title">
		<h5>文章${not empty xxgkNote.id?'修改':'添加'}</h5>
	</div>
			...
			<div class="row">
				<div class="col-sm-6">
					<div class="form-group">
						...
						<div class="col-sm-8">
							<sys:treeselect id="xxgkSysMenu" name="xxgkSysMenu.id" value="${xxgkNote.xxgkSysMenu.id}" labelName="xxgkSysMenu.name" labelValue="${xxgkNote.xxgkSysMenu.name}"
								title="文章分类" url="/xxgk/xxgkSysMenu/treeData" cssClass="form-control required" allowClear="true" notAllowSelectParent="true"/>
						</div>
					</div>
				</div>
			</div>
                        ...
                        <div class="col-sm-8">
                            <div class="input-group date datepicker">
                                <input name="releaseDate" path="releaseDate" type="text" readonly="readonly" class="form-control" 
                                    value="<fmt:formatDate value="${xxgkNote.releaseDate}" pattern="yyyy-MM-dd"/>" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',isShowClear:true});" >
