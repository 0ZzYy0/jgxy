	...
	<div class="wrapper-content">
		<div class="ibox">
			...
			<sys:message content="${message}"/>
				...
				<div class="row">
					<div class="col-sm-12">
						<form:form id="searchForm" modelAttribute="xxgkNote" action="${ctx}/xxgk/xxgkNote/selectList" method="post" class="form-inline">
				...
				<table id="contentTable" class="table table-bordered table-striped table-hover">
					...
					<c:forEach items="${page.list}" var="xxgkNote">
						<tr>
							...
							<td class="codelabel"><fmt:formatDate value="${xxgkNote.updateDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
							<td>${xxgkNote.xxgkSysMenu.id}</td>
							<td>${xxgkNote.title}</td>
							<td>
								<shiro:hasPermission name="xxgk:xxgkNote:view">
									<a href="#" onclick="openDialogView('查看文章', '${ctx}/xxgk/xxgkNote/view?id=${xxgkNote.id}','800px', '500px')" class="btn btn-info btn-xs" title="查看"><i class="fa fa-search-plus"></i> 查看</a>
								</shiro:hasPermission>
							</td>
						</tr>
					</c:forEach>
