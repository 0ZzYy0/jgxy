				...
				<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable">
					<thead>
						<tr>
							...
							<th width="100px" class="sort-column amount">订单总额(元)</th>
							<th width="100px" class="sort-column invoice_amt">开票金额(元)</th>
							...
							<th width="150px" class="sort-column audit_date">审核时间</th>
