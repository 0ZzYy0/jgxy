	...
	<form:form id="inputForm" modelAttribute="testUielement" action="${ctx}/test/ui/testUielement/save" method="post" class="form-horizontal">
			...
			<div class="row">
				<div class="col-sm-6">
					<div class="form-group">
						...
						<div class="col-sm-8">
							<wms:productselect id="product" name="product.id" value="${testUielement.product.id }" labelName="product.name" labelValue="${testUielement.product.name }" 
		...
		<br>
			<div class="form-actions">
				<shiro:hasPermission name="test:ui:testUielement:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
