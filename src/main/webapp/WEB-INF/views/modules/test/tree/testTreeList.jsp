...
<body class="">
	...
	<div class="ibox-header">
		...
		<div class="pull-right">
				<table:searchRow></table:searchRow><!-- 搜索按钮 -->
	...
	<script type="text/template" id="treeTableTpl">
		<tr id="{{row.id}}" pId="{{pid}}">
			...
			<shiro:hasPermission name="test:tree:testTree:edit">
   			...
   			<shiro:hasPermission name="test:tree:testTree:add">
				<a href="#" onclick="openDialog('添加下级树结构(商品分类)', '${ctx}/test/tree/testTree/form?parent.id={{row.id}}','800px', '500px')" class="btn btn-primary btn-xs" title="添加下级树结构(商品分类)">添加下级分类</a>
			</shiro:hasPermission>
