        		...
        		<div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                    	<div class="row text-center">
	                    	...
	                    	<div class="col-sm-2">
	                    		 <button type="button" class="btn btn-primary btn-circle m-r-sm" onclick="javascript:window.location.href='${ctx}/crm/crmChance/list?createBy.id=${fns:getUser().id}&beginRegularDate=${fns:getBeginDayOfMonthStr()}&endRegularDate=${fns:getEndDayOfMonthStr()}&regularStatus=1&status=0'"><i class="fa fa-file-o"></i></button>
			                    	<br>添加机会数：${myCrmReport.createChangeNum }
	                    	</div>
			                <div class="col-sm-2">
	                    		 <button type="button" class="btn btn-danger btn-circle m-r-sm" onclick="javascript:window.location.href='${ctx}/crm/crmChance/list?ownBy.id=${fns:getUser().id}&beginContractEndDate=${fns:getBeginDayOfMonthStr()}&endContractEndDate=${fns:getEndDayOfMonthStr()}'"><i class="fa fa-check"></i></button>
			                      	<br>负责机会数：${myCrmReport.ownChangeNum }
	                    	</div>     
			                <div class="col-sm-2">
                   		...
                   		<div class="search-result">
	                   		<div class="row">
		                   		<div class="col-sm-9">
		                            ...
		                            <p>
		                                <a href="${ctx}/crm/crmCustomer/crmIndex?id=${crmContactRecord.customer.id}">${crmContactRecord.customer.name}</a>
		                            </p>
		                            <div class="forum-sub-title">
            ...
            <div class="col-sm-3">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content no-padding">
                        <ul class="list-group">
                            <li class="list-group-item">
                                <a href="${ctx}/crm/crmContactRecord??contactDate=${fns:getDate('yyyy-MM-dd')}" class="badge <c:if test='${myCrmReport.dayUnContactCustomerNum > 0}'>badge-warning</c:if> ">${myCrmReport.dayUnContactCustomerNum }</a> 今日需联系
                            </li>
                            <li class="list-group-item ">
