	...
	<div id="main-navbar" class="navbar navbar-inverse" role="navigation">
		...
		<div class="navbar-inner">
			<div class="navbar-header">
				<a href="${ctx}/jgxy/jgxyNote/index" target="mainFrame" class="navbar-brand">${fns:getSysAccount().systemName}</a>
...
<%-- 							<li><a href="${ctx}/iim/myCalendar" target="mainFrame" title="我的日程"><i class="fa fa-calendar-o"></i></a></li>
							...
							<li class="dropdown">
								<a href="#" class="dropdown-toggle user-menu" data-toggle="dropdown" id="showHeadImg">
									<img src="${fns:getUser().photo}" onerror="this.src='http://www.yee800.com/user.png'">                                        
								...
								<ul class="dropdown-menu">
									...
									<li>
										<a class="J_menuItem" href="${ctx}/sys/user/modifyPwd" target="mainFrame"><i class="ace-icon fa fa-lock"></i>&nbsp;&nbsp;<span>更换密码</span></a>
									</li>
	                                
	                                <li class="divider"></li>
	                               
	                                <li>
	                                	<a href="#" onclick="toShowThemeDiv()"><i class="ace-icon fa fa-dashboard "></i>&nbsp;&nbsp;<span>样式设置</span></a>
	                                </li> 
			...
			<div class="menu-content top" id="menu-content-demo">
			    <div>
			        <div class="text-bg"><span class="text-semibold">${fns:getUser().name}</span></div>
      				...
      				<img src="${fns:getUser().photo}" alt="${fns:getUser().name}" onerror="this.src='http://www.yee800.com/user.png'">
                                        
			        <div class="btn-group">
			            <a href="${ctx }/sys/user/info" target="mainFrame" data-original-title="个人设置" class="btn btn-xs btn-primary btn-outline dark add-tooltip"><i class="fa fa-cog"></i></a>
			            ...
			            <a href="${ctx}/jgxy/jgxyNote/index" target="mainFrame" data-original-title="主页" class="btn btn-xs btn-danger btn-outline dark add-tooltip"><i class="fa fa-home fa-fw"></i></a>
			        </div>
	...
	<div class="row J_mainContent" id="content-main" style="margin-top: 48px;">
    	<iframe class="J_iframe" name="mainFrame" id="mainFrame" width="100%" height="100%" src="${ctx}/jgxy/jgxyNote/index" frameborder="0" data-id="${ctx}/jgxy/jgxyNote/index" seamless></iframe>
    </div>
