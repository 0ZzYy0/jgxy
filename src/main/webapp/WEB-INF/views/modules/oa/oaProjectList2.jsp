		...
		<div class="">
			<div class="ibox-header">
				...
				<div class="pull-right">
					...
					<a class="btn btn-white btn-sm" href="${ctx}/oa/oaProject/list2" title="刷新"><i class="fa fa-refresh"></i></a>
					<shiro:hasPermission name="oa:oaProject:edit">
					    <table:editRow url="${ctx}/oa/oaProject/form" title="项目" id="contentTable" pageModel="page"></table:editRow><!-- 编辑按钮 -->
					</shiro:hasPermission>
