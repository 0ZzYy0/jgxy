            ...
            <div class="ibox-content">            	
            	<div class="social-avatar">
                 <a href="" class="pull-left">
                     <img alt="image" src="${oaTopic.createBy.photo}" onerror="this.src='http://www.yee800.com/user.png'">
                 </a>
			...
			<div class="social-footer">
				<c:forEach items="${oaTopic.oaTopicRecordList}" var="oaTopicRecord" varStatus="status">
	                 <div class="social-comment">
	                     <a href="" class="pull-left">
	                         <img alt="image" src="${oaTopicRecord.user.photo}" onerror="this.src='http://www.yee800.com/user.png'">
	                     </a>
	                     <div class="media-body">
	                         <a href="#">
