						...
						<table id="contentTable" class="table table-bordered table-striped table-hover">
							<thead>
								<tr>
									...
									<th width="160px" class="sort-column a.create_date">创建时间</th>
								...
								<tr>
									...
									<td>
										...
										<shiro:hasPermission name="oa:oaWorkLog:edit">
					    					<a href="${ctx}/oa/oaWorkLog/form?id=${oaWorkLog.id}" class="btn btn-white btn-sm" title="修改"><i class="fa fa-pencil"></i> <span class="hidden-xs">修改</span></a>
										</shiro:hasPermission>
										
										<shiro:hasPermission name="oa:oaWorkLog:del">
											<a href="${ctx}/oa/oaWorkLog/delete?id=${oaWorkLog.id}" onclick="return confirmx('确认要删除该工作报告吗？', this.href)" class="btn btn-white btn-sm" title="删除"><i class="fa fa-trash"></i> <span class="hidden-xs">删除</span></a> 
										</shiro:hasPermission>
										</c:if>
									</td>
								</tr>
