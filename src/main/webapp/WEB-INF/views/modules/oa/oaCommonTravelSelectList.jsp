	...
	<div class="wrapper-content">
		<div class="ibox">
			...
			<sys:message content="${message}"/>
				...
				<div class="row">
					<div class="col-sm-12">
						<form:form id="searchForm" modelAttribute="oaCommonTravel" action="${ctx}/oa/oaCommonTravel/selectList" method="post" class="form-inline">
				...
				<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable">
					...
					<c:forEach items="${page.list}" var="oaCommonTravel">
						<tr>
							...
							<td class="codelabel">${oaCommonTravel.startAddress}</td>
							<td>${oaCommonTravel.destAddress}</td>
							<td><fmt:formatDate value="${oaCommonTravel.startTime}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
							<td><fmt:formatDate value="${oaCommonTravel.endTime}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
							<td>${oaCommonTravel.budgetAmt}</td>
							<td>${oaCommonTravel.advanceAmt}</td>
							<td>
