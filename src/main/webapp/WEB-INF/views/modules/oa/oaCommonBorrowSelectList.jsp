	...
	<div class="wrapper-content">
		<div class="ibox">
			...
			<sys:message content="${message}"/>
				...
				<div class="row">
					<div class="col-sm-12">
						<form:form id="searchForm" modelAttribute="oaCommonBorrow" action="${ctx}/oa/oaCommonBorrow/selectList" method="post" class="form-inline">
				...
				<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable">
					...
					<c:forEach items="${page.list}" var="oaCommonBorrow">
						<tr>
							...
							<td class="codelabel">${oaCommonBorrow.amount}</td>
							<td><fmt:formatDate value="${oaCommonBorrow.borrowDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
							<td>
