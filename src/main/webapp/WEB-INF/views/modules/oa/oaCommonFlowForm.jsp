...
<div class="ibox">
	...
	<form:form id="inputForm" modelAttribute="oaCommonFlow" action="${ctx}/oa/oaCommonFlow/save" method="post" class="form-horizontal">
	 ...
	 <table class="table table-bordered table-condensed dataTables-example dataTable no-footer">
		<tbody>
			<tr>
					<td class="width-15 active"><label class="pull-right"><font color="red">*</font> 审批类型：</label></td>
					<td class="width-35">
					...
					<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed">
						<thead>
							<tr>
								...
								<th>执行类型</th>
								<th>执行人</th>
								<shiro:hasPermission name="oa:oaCommonFlow:list"><th width="10">&nbsp;</th></shiro:hasPermission>
							</tr>
						</thead>
		...
		<br>
			<div class="form-actions">
				<shiro:hasPermission name="oa:oaCommonFlow:list"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
