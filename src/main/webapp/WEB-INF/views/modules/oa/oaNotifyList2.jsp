	...
	<table id="contentTable" class="table table-striped table-bordered  table-hover table-condensed  dataTables-example dataTable no-footer">
		...
		<c:forEach items="${page.list}" var="oaNotify">
			<tr>
				...
				<td><a  href="#" onclick="openDialogView('查看通知', '${ctx}/oa/oaNotify/view?id=${oaNotify.id}','800px', '80%')">
				...
				<c:if test="${!requestScope.oaNotify.self}">
					<shiro:hasPermission name="oa:oaNotify:view">
						<a href="#" onclick="openDialogView('查看通知', '${ctx}/oa/oaNotify/view?id=${oaNotify.id}','800px', '80%')" class="btn btn-info btn-xs" ><i class="fa fa-search-plus"></i></a>
					</shiro:hasPermission>
					<shiro:hasPermission name="oa:oaNotify:edit">
    					<a href="#" onclick="openDialog('修改通知', '${ctx}/oa/oaNotify/form?id=${oaNotify.id}','800px', '80%')" class="btn btn-success btn-xs" ><i class="fa fa-edit"></i></a>
    				</shiro:hasPermission>
    				<shiro:hasPermission name="oa:oaNotify:del">
