	...
	<div class="ibox">
		...
		<form:hidden path="oaCommonAudit.oaCommonFlowId"/>
			...
			<div class="row">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<div class="input-group date datepicker">
		                     	<input name="startTime" type="text" readonly="readonly" class="form-control required" value="<fmt:formatDate value="${oaCommonExtra.startTime}" pattern="yyyy-MM-dd HH:mm:ss"/>" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',isShowClear:true});" >
				...
				<div class="col-sm-6">
					<div class="form-group">
						...
						<div class="col-sm-8">
							<div class="input-group date datepicker">
		                     	<input name="endTime" type="text" readonly="readonly" class="form-control required" value="<fmt:formatDate value="${oaCommonExtra.endTime}" pattern="yyyy-MM-dd HH:mm:ss"/>" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',isShowClear:true});" >
		                     	<span class="input-group-addon">
		                             <span class="fa fa-calendar"></span>
		                     	</span>
					        </div>
			...
			<div class="row">
				<div class="col-sm-6">
					<div class="form-group">
						<label class="col-sm-4 control-label"><font color="red">*</font> 加班类型</label>
						<div class="col-sm-8">
							<form:select path="extraType" cssClass="form-control required">
				...
				<div class="col-sm-6">
					<div class="form-group">
						<label class="col-sm-4 control-label"><font color="red">*</font> 加班时长(天)</label>
						<div class="col-sm-8">
							<form:input path="daysNum" htmlEscape="false" class="form-control number required" maxlength="5" min="0.5" max="30"/>
						</div>
					</div>
				</div>
			</div>
