...
<div class="wrapper-content pb80">
							            	...
							            	<label class="col-sm-3 control-label"><font color="red">*</font>生成模板</label>
							            	 <div class="col-sm-8">
												...
												<div id="select_div" class="mt10" <c:if test='${genTable.category != "treeTableAndList"}'>style="display: none;"</c:if> >
													...
													<form:input path="treeData" htmlEscape="false" maxlength="50" class="required input-xlarge" placeholder="树形列表对象"/>
													<span class="help-inline">"左树右表"的情况下，必须指明树形列表对象，如：sys/office</span>
												</div>
							                 </div>
							            </div>
						            </div>
										...
										<div class="form-group">
							            	<label class="col-sm-3 control-label"><font color="red">*</font>包路径</label>
							            	 <div class="col-sm-8">
												...
												<span class="help-inline">建议模块包：com.javafast.modules</span>
							                 </div>
							            </div>
						            </div>
						        </div>
										...
										<div class="form-group">
							            	<label class="col-sm-3 control-label">子模块名</label>
							            	 <div class="col-sm-8">
												...
												<span class="help-inline">可选，分层下的文件夹user </span>
							                 </div>
							            </div>
						            </div>
						        </div>
										...
										<div class="form-group">
							            	<label class="col-sm-3 control-label"><font color="red">*</font>表单模型</label>
							            	 <div class="col-sm-8">
												...
												<span class="help-inline">新增修改页面的显示方式</span>
							                 </div>
							            </div>
						            </div>
						        </div>
	...
	<c:if test="${not empty genTable.name}">
	<div class="row border-bottom white-bg dashboard-header dashboard-footer">
         <div class="col-sm-12">
        	<div class="text-center">
        	
        			<input id="btnSave" class="btn btn-primary btn-sm" type="submit" value="保  存"/>
