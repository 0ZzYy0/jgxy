	...
	<div class="wrapper-content">
		<div class="ibox">
			...
			<sys:message content="${message}"/>
				...
				<div class="row">
					<div class="col-sm-12">
						<form:form id="searchForm" modelAttribute="payBankbookBalance" action="${ctx}/pay/payBankbookBalance/selectList" method="post" class="form-inline">
				...
				<table id="contentTable" class="table table-bordered table-striped table-hover">
					<thead>
						<tr>
							...
							<th class="sort-column a.id">ID</th>
					...
					<c:forEach items="${page.list}" var="payBankbookBalance">
						<tr>
							...
							<td class="codelabel">${payBankbookBalance.id}</td>
							<td>${payBankbookBalance.balance}</td>
							<td>
