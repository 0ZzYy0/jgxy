	...
	<div class="wrapper-content">
		<div class="ibox">
			...
			<sys:message content="${message}"/>
				...
				<div class="row">
					<div class="col-sm-12">
					<form:form id="searchForm" modelAttribute="crmReport" action="${ctx}/report/fiReport/list" method="post" class="form-inline">
							...
							<div class="form-group">
								...
								<a class="btn btn-white" href="${ctx}/report/fiReport/list"/>重置</a>
							</div>
				...
				<c:forEach items="${crmReportList}" var="crmReport">
					<tr>
						...
						<td>
							${crmReport.receiveAmt}
						</td>
						<td>
							${crmReport.alReceiveAmt}
						</td>
						<td>
							${crmReport.rePayAmt}
						</td>
