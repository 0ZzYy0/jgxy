...
<meta name="author" content="http://www.javafast.cn/"/>
...
<link href="${ctxStatic}/jquery-select2/4.0.2/css/select2.min.css" rel="stylesheet" />
<script src="${ctxStatic}/jquery-select2/4.0.2/js/select2.min.js" type="text/javascript"></script>
...
<link href="${ctxStatic}/iCheck/skins/minimal/blue.css" rel="stylesheet"/>
...
<!-- javafast -->
<link href="${ctxStatic}/common/javafast.css" type="text/css" rel="stylesheet" />
<script src="${ctxStatic}/common/javafast.js" type="text/javascript"></script>

<!-- jquery ui -->
<script src="${ctxStatic}/jquery-ui/jquery-ui.min.js"></script>

<!-- 引入bootstrap插件 -->
<!-- bootswatch主题，如果你想切换主题请访问http://bootswatch.com/下载最新版版主题 -->
