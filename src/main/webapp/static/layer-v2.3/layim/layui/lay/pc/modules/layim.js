...
layui.define(['jquery', 'layer', 'laytpl', 'upload'], function(exports){
  ...
  var elemTpl = ['<div class="layui-layim-main">'
    ,'<div class="layui-layim-info">'
      ...
      ,'<div class="layui-layim-status">'
        ...
        ,'</ul>'
      ,'</div>'
      ,'<p class="layui-layim-remark" title="{{# if(d.mine.sign){ }}{{d.mine.sign}}{{# } }}"><input id="layim_user_sign_box" type="text" value="{{ d.mine.remark||d.mine.sign||"你很懒，没有写签名" }}" class="layim-sign-box layim-sign-hide" style="background-color:transparent;"></p>'
    ,'</div>'
  ...
  var layimClose, popmin = function(content){
    ...
    return layer.open({
      ...
      ,shift: 2
      ,offset: 'rb'
      ,content: '<img src="'+ (cache.mine.avatar||(layui.cache.dir+'css/pc/layim/skin/logo.jpg')) +'"><span>'+ (content||cache.base.title||'内部沟通') +'</span>'
  ...
  var anim = 'layui-anim-up', events = {
    ...
    //弹出查找页面
    ,find: function(){
    	parent.mainFrame.location.href="http://demo.javafast.cn/jf/iim/contact/myFriends";
    }
