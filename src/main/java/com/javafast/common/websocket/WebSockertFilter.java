package com.javafast.common.websocket;
...
import com.javafast.common.websocket.onchat.ChatServer;
...
public class WebSockertFilter implements Filter {
	...
	public void startWebsocketChatServer() {
		...
		ChatServer s;
		try {
			s = new ChatServer(8118);
			s.start();
			System.out.println("信息: 启动websocket服务器，端口" + s.getPort()+"");
