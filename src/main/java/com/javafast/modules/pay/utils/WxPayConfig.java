...
//	
//	//公众账号ID
//	public static final String appid = "wx105b93c9ea2fe82e";
//	
//	//商户号
//	public static final String mch_id = "1491813942";
//	
//	//api秘钥
//	public static final String key = "syh9144031862050896100MA5DM8KN5G";
//	
//	//通知地址  异步接收微信支付结果通知的回调地址，通知url必须为外网可访问的url，不能携带参数。	
//	public static final String notify_url = "http://demo.javafast.cn/jf/pay/wxPay/payReceive";
