...
import com.javafast.common.utils.excel.fieldtype.RoleListType;
...
public class User extends DataEntity<User> {
	...
	private String loginFlag;	// 是否允许登陆 1:是，0：否
	...
	private String bindWx;  //同步到企业微信 1:是
	private String userId;  //微信成员唯一的userid	
	private User ownBy;  //工作移交时的接收人
	...
	@Length(min=0, max=50, message="电话长度必须介于 1 和 50 之间")
	...
	@Length(min=0, max=50, message="手机长度必须介于 1 和 50 之间")
	...
	@Length(min=0, max=1, message="用户类型长度必须介于 1 和 1 之间")
